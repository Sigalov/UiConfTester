...
public abstract class KalturaLiveChannelSegmentBaseFilter extends KalturaFilter {
    ...
    public float startTimeGreaterThanOrEqual = Float.MIN_VALUE;
    public float startTimeLessThanOrEqual = Float.MIN_VALUE;
    ...
    public KalturaLiveChannelSegmentBaseFilter(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("createdAtGreaterThanOrEqual")) {
                ...
                this.startTimeGreaterThanOrEqual = ParseUtils.parseFloat(txt);
                continue;
            } else if (nodeName.equals("startTimeLessThanOrEqual")) {
                this.startTimeLessThanOrEqual = ParseUtils.parseFloat(txt);
                continue;
            } 
        }
    }
