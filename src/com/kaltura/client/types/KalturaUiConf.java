...
public class KalturaUiConf extends KalturaObjectBase {
	static KalturaLogger logger = KalturaLogger.getLogger(KalturaUiConf.class);
    ...
    public KalturaParams toParamsCustom() {
        KalturaParams kparams = super.toParams();
        kparams.add("objectType", "KalturaUiConf");
        kparams.add("name", this.name);
        kparams.add("description", this.description);
   ...
   public boolean assertEquals(KalturaUiConf actual){
//	   String text1 = this.toParams().toString().replace(oldChar, newChar)//Rgex
	   return this.toParamsCustom().toString().equals(actual.toParamsCustom().toString());
   }
}
