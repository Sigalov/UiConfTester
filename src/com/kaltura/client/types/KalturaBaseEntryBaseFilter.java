...
public abstract class KalturaBaseEntryBaseFilter extends KalturaFilter {
    ...
    public String redirectEntryIdEqual;
    ...
    public KalturaBaseEntryBaseFilter(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                continue;
            } else if (nodeName.equals("redirectEntryIdEqual")) {
                this.redirectEntryIdEqual = ParseUtils.parseString(txt);
                continue;
    ...
    public KalturaParams toParams() {
        ...
        kparams.add("redirectEntryIdEqual", this.redirectEntryIdEqual);
