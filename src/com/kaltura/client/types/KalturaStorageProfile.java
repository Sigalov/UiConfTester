...
public class KalturaStorageProfile extends KalturaObjectBase {
    ...
    public String deliveryHttpsBaseUrl;
    ...
    public KalturaStorageProfile(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                continue;
            } else if (nodeName.equals("deliveryHttpsBaseUrl")) {
                this.deliveryHttpsBaseUrl = ParseUtils.parseString(txt);
                continue;
    ...
    public KalturaParams toParams() {
        ...
        kparams.add("deliveryHttpsBaseUrl", this.deliveryHttpsBaseUrl);
