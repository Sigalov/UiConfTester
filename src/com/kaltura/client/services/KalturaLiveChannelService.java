...
public class KalturaLiveChannelService extends KalturaServiceBase {
    ...
    public void appendRecording(String entryId, KalturaMediaServerIndex mediaServerIndex, KalturaServerFileResource resource, float duration) throws KalturaApiException {
        KalturaParams kparams = new KalturaParams();
        kparams.add("entryId", entryId);
        kparams.add("mediaServerIndex", mediaServerIndex);
        kparams.add("resource", resource);
        kparams.add("duration", duration);
        this.kalturaClient.queueServiceCall("livechannel", "appendRecording", kparams);
        if (this.kalturaClient.isMultiRequest())
            return ;
        this.kalturaClient.doQueue();
    }
